...
namespace SimpleOT.Domain
{
	...
	{
		#region Loader
		private static readonly IDictionary<ushort, ItemType> TYPES = new Dictionary<ushort, ItemType>();
		
		public static uint MajorVersion{get;private set;}
		public static uint MinorVersion{get;private set;}
		public static uint BuildNumber{get;private set;}
		...
		private static void LoadOtb(string fileName)
        {
